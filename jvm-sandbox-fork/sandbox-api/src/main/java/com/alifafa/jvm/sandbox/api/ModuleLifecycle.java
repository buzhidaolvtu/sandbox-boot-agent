...
public interface ModuleLifecycle extends LoadCompleted {
     ...
     * 模块激活
     * <p>
     * 模块被激活后，模块所增强的类将会被激活，所有{@link com.alifafa.jvm.sandbox.api.listener.EventListener}将开始收到对应的事件
     * </p>
     * <p>
     ...
     * 模块冻结
     * <p>
     * 模块被冻结后，模块所持有的所有{@link com.alifafa.jvm.sandbox.api.listener.EventListener}将被静默，无法收到对应的事件。
