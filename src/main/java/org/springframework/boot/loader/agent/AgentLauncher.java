...
//            Archive jarArchive = iterator.next();
//            Iterator<Archive.Entry> entryIterator = jarArchive.iterator();
//            while (entryIterator.hasNext()) {
//                Archive.Entry entry = entryIterator.next();
//                System.out.println("entry:" + entry.getName());
//                if (!entry.getName().contains("sandbox-agent.jar")) {
//                    iterator.remove();
//                }
//            }
//        }
